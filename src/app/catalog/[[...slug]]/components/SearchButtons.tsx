  ...
  return (
    <section className="container mb-[100px] max-md:mb-[50px] px-5">
      {selectedCategory?.material && (
        <>
          <h3 className="title-white text-title-large mb-5">MATERIAL</h3>
          <div className="flex flex-wrap gap-5  mb-10 max-md:overflow-x-auto max-md:flex-nowrap no-scrollbar">
            {selectedCategory &&
      ...
      {selectedCategory?.brands && (
        <>
          <h3 className="title-white text-title-large mb-5">BRANDS</h3>
          <div className="flex gap-5  mb-10 overflow-x-auto no-scrollbar">
            {selectedCategory &&
