...
export const CatalogHero: React.FC = () => {
	...
	return (
		<section className="container mx-auto mt-[40px] inside-mb relative z-10">
			<ul className=" gap-5 cursor-pointer flex mx-auto overflow-x-auto no-scrollbar text-title text-main-yellow inside-mb">
			...
			{/* search hero buttons */}
			<div className="lg:flex lg:flex-wrap lg:justify-center overflow-x-auto no-scrollbar grid grid-flow-col grid-rows-2 gap-5 inside-mb">
				{selectedCategory &&
