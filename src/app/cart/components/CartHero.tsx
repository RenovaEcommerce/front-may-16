...
export const CartHero: FC = () => {
	...
	return (
		<section className="w-full sm:w-11/12 max-w-[1440px] mx-auto mt-[32px] px-[10px] mb-[40px] text-white flex flex-col lg:flex-row lg:items-center lg:justify-between">
