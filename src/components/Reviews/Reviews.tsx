		...
		<section className="w-full max-w-[1440px] px-[10px] mx-auto z-10 relative text-main-gray mb-[100px] max-md:mb-[50px]">
			<div className="flex flex-col items-center md:flex-row">
				<div className="md:text-center md:pr-8 w-full md:w-[35%]">
					...
					<ul className="flex overflow-x-auto no-scrollbar overflow-y-hidden md:flex-col items-center">
						{topProducts.map((topProduct) => (
							<li
								className="flex w-[200px] items-center justify-center mb-0 md:mb-[10px] p-[8px]! max-md:p-[9px] text-primary small-button"
