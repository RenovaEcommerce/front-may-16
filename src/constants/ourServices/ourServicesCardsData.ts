interface ServiceCard {
  ...
  export const ourServicesCardsData: ServiceCategory = {
	...
	roofing: [
	  ...
	  {
		heading: "Roof Repair",
		paragraph: "Resolve roofing issues promptly with our roof repair services.",
	...
	siding: [
	  ...
	  },
	  {
		...
		paragraph: "Restore the beauty and integrity of your siding with our repair services.",
	  ...
	  },
	  {
		...
		paragraph: "Upgrade to low-maintenance and versatile vinyl siding for your home.",
	  ...
	  },
	  {
		...
		paragraph: "Opt for durable and weather-resistant Hardie siding for long-lasting protection.",
	  ...
	  },
	  {
		...
		paragraph: "Enhance your home's natural charm with beautiful cedar siding.",
	  ...
	  },
	  {
		...
		paragraph: "Choose lightweight and durable aluminum siding for your home's exterior.",
	  ...
	  },
	  {
		...
		paragraph: "Add elegance and texture to your home with stylish stone veneer siding.",
	  ...
	  },
	  {
		...
		paragraph: "Opt for eco-friendly and durable composite siding for your home.",
	...
	excavation: [
	  ...
	  {
		heading: "Earthworks",
		paragraph: "Shape and mold the land to suit your construction needs with earthworks.",
	  ...
	  {
		heading: "Grading",
		paragraph: "Achieve a level and stable surface for construction with our grading services.",
		url: "/service/grading",
		image: "service_image_kitchen_addition",
		price: "Price starts at $6,000",
	  },
	  {
		...
		paragraph: "Clear your land of obstacles and vegetation to prepare for construction.",
	  ...
	  },
	  {
		...
		paragraph: "Efficiently remove excess dirt and debris from your construction site.",
	...
	basement: [
	  ...
	  },
	  {
		...
		paragraph: "Choose from a variety of flooring options to enhance your basement's comfort and style.",
	  ...
	  },
	  {
		...
		paragraph: "Revamp your basement for improved functionality and aesthetics with our remodeling services.",
	  ...
	  },
	  {
		...
		paragraph: "Create the ultimate entertainment space in your basement with our customized solutions.",
	  ...
	  },
	  {
		...
		paragraph: "Add convenience and value to your basement with a professionally installed bathroom.",
	  ...
	  },
	  {
		...
		paragraph: "Protect your basement from moisture and water damage with our waterproofing solutions.",
	  ...
	  },
	  {
		...
		paragraph: "Ensure year-round comfort and energy efficiency in your basement with proper insulation.",
	  ...
	  },
	  {
		...
		paragraph: "Create a stylish and functional bar space in your basement for entertaining guests.",
	  ...
	  },
	  {
		...
		paragraph: "Brighten up your basement and improve ventilation with new windows.",
	...
	attic: [
	  ...
	  },
	  {
		...
		paragraph: "Gain easy access to your attic with a professionally installed attic ladder.",
	  ...
	  },
	  {
		...
		paragraph: "Ensure energy efficiency and comfort in your home with proper attic insulation.",
	  ...
	  },
	  {
		...
		paragraph: "Finish your attic walls with durable and attractive drywall.",
	  ...
	  },
	  {
		...
		paragraph: "Brighten up your attic space and improve ventilation with new windows and skylights.",
	  ...
	  },
	  {
		...
		paragraph: "Maximize your attic space with customized storage solutions.",
	  ...
	  },
	  {
		...
		paragraph: "Ensure proper airflow and ventilation in your attic for improved comfort and energy efficiency.",
	  ...
	  },
	  {
		...
		paragraph: "Illuminate your attic space with effective and energy-efficient lighting solutions.",
	  ...
	  },
	  {
		...
		paragraph: "Ensure year-round comfort in your attic with effective heating and cooling solutions.",
	  ...
	  },
	  {
		...
		paragraph: "Add convenience and value to your home with a professionally installed attic bathroom.",
	...
	landscaping: [
	  ...
	  },
	  {
		...
		paragraph: "Transform your outdoor space with customized landscape design solutions.",
		url: "/service/landscape-design",
		image: "service_image_kitchen_addition",
		price: "Price starts at $3,500",
	  },
	  {
		heading: "Grading",
		paragraph: "Achieve a level and stable surface for your landscape with our grading services.",
		url: "/service/grading",
		image: "service_image_kitchen_addition",
		price: "Price starts at $6,000",
	  },
	  {
		heading: "Planting",
		paragraph: "Enhance the beauty of your landscape with expert planting services.",
	  ...
	  },
	  {
		...
		paragraph: "Remove unwanted or hazardous trees from your landscape safely and efficiently.",
	  ...
	  },
	  {
		...
		paragraph: "Create an inviting outdoor living space with our professional patio installation services.",
	  ...
	  },
	  {
		...
		paragraph: "Achieve a lush and healthy lawn quickly with our sod installation services.",
	  ...
	  },
	  {
		...
		paragraph: "Enhance privacy and security in your outdoor space with our fence installation services.",
	  ...
	  },
	  {
		...
		paragraph: "Add functionality and visual appeal to your landscape with professionally built retaining walls.",
	  ...
	  {
		heading: "Fountain",
		paragraph: "Add elegance and tranquility to your landscape with a beautiful fountain feature.",
	  ...
	  {
		heading: "Fire Pits",
		paragraph: "Create a cozy gathering spot in your outdoor space with a custom fire pit.",
	  ...
	  },
	  {
		...
		paragraph: "Enhance accessibility and aesthetics in your landscape with professionally installed paths.",
	  ...
	  },
	  {
		...
		paragraph: "Ensure your landscape stays lush and healthy with a professionally installed irrigation system.",
	  ...
	  },
	  {
		...
		paragraph: "Restore the beauty of your outdoor surfaces with our power washing services.",
	  ...
	  },
	  {
		...
		paragraph: "Keep your landscape pristine and weed-free with our effective weed control solutions.",
	  ...
	  {
		heading: "Landscape Lighting",
		paragraph: "Highlight the beauty of your landscape and enhance safety with professionally installed lighting.",
		url: "/service/landscape-lighting",
		image: "service_image_kitchen_addition",
		price: "Price starts at $1,800",
	  },
	...
	painting: [
	  ...
	  },
	  {
		...
		paragraph: "Protect and beautify your home's exterior with our expert exterior painting services.",
	  ...
	  {
		heading: "Cabinet Painting",
		paragraph: "Transform the look of your cabinets with our high-quality cabinet painting services.",
		url: "/service/cabinet-painting",
		image: "service_image_kitchen_addition",
		price: "Price starts at $1,800",
	  },
	  {
		...
		paragraph: "Enhance the visual appeal of your space with professionally painted trim.",
	  ...
	  },
	  {
		...
		paragraph: "Add personality and style to any room with our expert room painting services.",
	  ...
	  },
	  {
		...
		paragraph: "Brighten and refresh your space with professionally painted ceilings.",
	  ...
	  },
	  {
		...
		paragraph: "Protect and enhance your deck with our professional deck painting services.",
	  ...
	  },
	  {
		...
		paragraph: "Give your home's siding a fresh new look with our expert siding painting services.",
	  ...
	  },
	  {
		...
		paragraph: "Revitalize your fence and enhance your outdoor space with our fence painting services.",
	  ...
	  {
		heading: "Varnishing",
		paragraph: "Protect and enhance the natural beauty of wood surfaces with our varnishing services.",
	  ...
	  {
		heading: "Stucco",
		paragraph: "Restore and beautify your stucco surfaces with our professional stucco services.",
		url: "/service/stucco",
		image: "service_image_kitchen_addition",
		price: "Price starts at $3,500",
	  },
	...
	masonry: [
	  ...
	  },
	  {
		...
		paragraph: "Add timeless beauty to your property with our professional stone masonry services.",
	  ...
	  {
		heading: "Seismic Retrofitting",
		paragraph: "Ensure the safety and stability of your property with our seismic retrofitting services.",
		url: "/service/seismic-retrofitting",
		image: "service_image_kitchen_addition",
		price: "Price starts at $7,000",
	  },
	  {
		...
		paragraph: "Keep your chimney in top condition with our expert chimney masonry services.",
	  ...
	  },
	  {
		...
		paragraph: "Build durable structures with our professional concrete block services.",
	  ...
	  },
	  {
		...
		paragraph: "Restore the beauty and integrity of your masonry with our restoration services.",
	  ...
	  {
		heading: "Stone Veneer",
		paragraph: "Enhance your property's appearance with stylish and durable stone veneer.",
		url: "/service/stone-veneer",
		image: "service_image_kitchen_addition",
		price: "Price starts at $8,000",
	  },
	  {
		...
		paragraph: "Trust our expertise for all your commercial masonry needs.",
