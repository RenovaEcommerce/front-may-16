export const mainPageContent = {
	...
	perks: [
		{
			...
			paragraph:
				"From updating your powder room with new fixtures to complete bathroom renovations in Victoria, we offer end-to-end services to bring your vision to life.",
		},
		{
			heading: "Expert Team by Your Side",
			paragraph:
				"Our team, from bathroom renovators near me to design experts, ensures each project is completed to the highest standards, offering peace of mind and satisfaction.",
		},
		{
			heading: "Streamlined Process",
			paragraph:
				"We simplify the remodeling process, handling everything from design to the final reveal, ensuring a seamless experience for every homeowner.",
		},
		{
			heading: "Quality Materials and Craftsmanship",
			paragraph:
				"We source the best materials for every aspect of your project, from bathroom floor tiles to custom cabinetry, ensuring durability and style.",
		},
		{
			heading: "Customer-Centric Approach",
			paragraph:
				"Your satisfaction is our top priority. We work closely with you to ensure every aspect of your bathroom remodel exceeds your expectations.",
		},
	],
	aboutSection: {
	...
	markdown2:
		"## Renova: Crafting Dream Homes\n\nUnlock the potential of your home with Renova. Whether it's a modern kitchen or a spa-inspired bathroom, our team specializes in bringing your vision to life. Get ready to fall in love with your home all over again.\n\n## Personalized Solutions, Every Time\n\nAt Renova, we understand that no two homes are alike. That's why we offer tailored solutions that cater to your specific needs, ensuring a seamless blend of style and functionality.\n\n## Experience Excellence with Renova\n\nWhen you choose Renova, you're choosing excellence. With a focus on quality craftsmanship and customer satisfaction, we're dedicated to making your remodeling journey unforgettable.",
	whySection: {
		whyArray: [
			{
				id: 1,
	...
	faqItems: [
		{
			question:
				"Why choose Renova for bathroom remodeling in Victoria, BC?",
			answer: "Renova is recognized for our exceptional craftsmanship, personalized services, and our dedication to meeting the specific needs and vision of our clients in Victoria, BC. Our expertise ensures your bathroom remodeling project is executed flawlessly, transforming your space into a functional and stylish retreat.",
		},
		{
			question:
				"What does the bathroom remodeling process with Renova in Victoria, BC involve?",
		...
		{
			question:
				"How can I get an estimate for my bathroom remodel in Victoria, BC?",
			answer: "To get an estimate for your bathroom remodel, simply contact Renova. We will arrange a visit to your property to assess the space and discuss your remodeling goals. Based on this, we will provide you with a detailed estimate, including costs and timelines.",
		},
		{
			question:
				"Can Renova help with small bathroom remodels in Victoria, BC?",
			answer: "Absolutely. Renova specializes in remodeling projects of all sizes in Victoria, BC, including small bathrooms. Our team can help maximize your space's potential, incorporating smart design and storage solutions to create a bathroom that meets your needs and preferences.",
		},
		{
			question:
				"What are some popular trends in bathroom remodeling in Victoria, BC?",
			answer: "Popular trends in Victoria, BC include spa-like bathrooms with luxurious fixtures, eco-friendly materials and fixtures, smart storage solutions, and the use of natural light. Renova stays ahead of trends to offer contemporary, stylish, and functional bathroom designs.",
		},
		{
			question:
				"Does Renova handle all aspects of bathroom remodeling, including plumbing and electrical work?",
			answer: "Yes, Renova manages all aspects of your bathroom remodel in Victoria, BC, including plumbing, electrical work, and installation of fixtures and fittings. Our experienced team ensures that all work is completed to the highest standards, adhering to local building codes and regulations.",
		},
	],
	markdown3:
